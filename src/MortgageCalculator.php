...
namespace burnthebook\mortgagecalculator;

use burnthebook\mortgagecalculator\variables\MortgageCalculatorVariable;
use burnthebook\mortgagecalculator\twigextensions\MortgageCalculatorTwigExtension;
use burnthebook\mortgagecalculator\models\Settings;
 ...
 */
class MortgageCalculator extends Plugin
{
	// Static Properties
	// =========================================================================
	...
	public function init()
	{
		...
		Craft::$app->view->registerTwigExtension(new MortgageCalculatorTwigExtension());
		...
		Event::on(
			...
			function (RegisterUrlRulesEvent $event) {
				$event->rules['siteActionTrigger1'] = 'mortgage-calculator/default';
			}
		);
		...
		Event::on(
			...
			function (RegisterUrlRulesEvent $event) {
				$event->rules['cpActionTrigger1'] = 'mortgage-calculator/default/do-something';
			}
		);
		...
		Event::on(
			...
			function (Event $event) {
				...
				$variable->set('mortgageCalculator', MortgageCalculatorVariable::class);
			}
		);
	...
	{
		// Get existing stamp duty settings
		$stampDutySettings = $this->getSettings()->stampDutySettings;

		if (!$stampDutySettings) {
